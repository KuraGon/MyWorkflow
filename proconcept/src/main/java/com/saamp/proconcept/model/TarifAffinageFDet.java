...
@Data
@Entity
@Table(name = "IND_PTC_TARIFF_AFFINAGE_F_DET")
public class TarifAffinageFDet {

    @Id
    @Column(name = "IND_PTC_TARIFF_AFFINAGE_F_DET_ID")
    private Long id;

    @Column(name = "C_IND_PTC_CODE_TARIF_DET")
